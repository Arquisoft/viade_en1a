...
****
The goal of this project is to develop an application which is able to store user pictures in a *decentralized* manner but still manages to share these decentralized pictures with other users.
