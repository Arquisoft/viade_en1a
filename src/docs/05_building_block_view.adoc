...
[plantuml,"MVC Block Diagram",png]
----
package "MVC" {
...
Friends --> Friends :Sends --> Routes
Notifications --> Routes :Include



ShareRoute --> Friends:Uses
ShareRoute --> Routes:Uses

FriendsList --> Friends:Uses

Maps --> Routes:Lists

SolidModels -->  Solid

Controller --> ViadeModels: "Modifies"
Controller --> SolidModels: "Modifies"

Views --> Controller : "User controller"
----

Let's explore the main models for the viade app

Routes::
[plantuml,"Routes uml",png]
----
class Routes {
  +name
  +author
...
Notifications::
Notifications are used for alerting users of new pictures that have been shared with them by friends.
